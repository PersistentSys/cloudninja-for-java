...
<% int i=0; %>			
	<tr>
		...
		<td>
			...
			</form:form><form:form action="listDetails.htm" commandName="taskListDTO.taskList[${varStatus.index}]" method="POST" id="formdetail${varStatus.index}">
			<spring:bind path="taskId">
				<input type="hidden" value="${task.taskId}" name="taskId" />
			</spring:bind>
			<spring:bind path="subject">
			...
			</form:form><form:form action="deleteList.htm" commandName="taskListDTO.taskList[${varStatus.index}]" method="POST" id="formdelete${varStatus.index}" >
 			<spring:bind path="taskId">
				<input type="hidden" value="${task.taskId}" name="taskId" />
			</spring:bind>
			<spring:bind path="subject">
