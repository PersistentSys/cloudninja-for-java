...
/**
 * DAO Interface for  Tenant Web Band Width Usage Flow
 *
 */
public interface WebLogMeteringBatchDao {

    List<WebLogMeteringBatch> getMeteringBatchServiceDetails(String uri);
