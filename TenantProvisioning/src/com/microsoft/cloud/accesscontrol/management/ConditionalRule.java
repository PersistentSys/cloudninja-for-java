...
public class ConditionalRule {
    ...
    private String conditionClaimType;
    private String conditionClaimValue;
    private long conditionIssuerId;
     ...
     */
    public ConditionalRule(long id) {
        this();
        this.id = id;
    }

   /**
    * Returns the value of the "conditionClaimType" attribute.
    *
    * @return The value of the "conditionClaimType" attribute.
    */
   public String getConditionClaimType() {
      return conditionClaimType;
   }
   /**
    * Returns the value of the "conditionClaimValue" attribute.
    *
    * @return The value of the "conditionClaimValue" attribute.
    */
   public String getConditionClaimValue() {
      return conditionClaimValue;
   }
   /**
    * Returns the value of the "conditionIssuerId" attribute.
    *
    * @return The value of the "conditionIssuerId" attribute.
    */
   public long getConditionIssuerId() {
      return conditionIssuerId;
   }
   /**
   ...
   /**
    * Sets the value of the "conditionClaimType" attribute.
    *
    * @param conditionClaimType
    *     The value of the "conditionClaimType" attribute.
    */
   public void setConditionClaimType(String conditionClaimType) {
      this.conditionClaimType = conditionClaimType;
   }
   /**
    * Sets the value of the "conditionClaimValue" attribute.
    *
    * @param conditionClaimValue
    *     The value of the "conditionClaimValue" attribute.
    */
   public void setConditionClaimValue(String conditionClaimValue) {
      this.conditionClaimValue = conditionClaimValue;
   }
   /**
    * Sets the value of the "conditionIssuerId" attribute.
    *
    * @param conditionIssuerId
    *     The value of the "conditionIssuerId" attribute.
    */
   public void setConditionIssuerId(long conditionIssuerId) {
      this.conditionIssuerId = conditionIssuerId;
   }
   /**
