...
public class TenantUsageRowMapper implements RowMapper<Metering>{

	@Override
	public Metering mapRow(ResultSet rs, int rowNum) throws SQLException {
		Metering usage = new Metering();
