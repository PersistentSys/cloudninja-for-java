...
import com.microsoft.cloudninja.domainobject.MemberRole;
import com.microsoft.cloudninja.domainobject.TenantBean;
...
import com.microsoft.cloudninja.transferObjects.DeleteManageUsersDTO;
import com.microsoft.cloudninja.transferObjects.ManageUsersDTO;
import com.microsoft.cloudninja.transferObjects.UpdateManageUsersDTO;
import com.microsoft.cloudninja.validator.ManageUsersCreateValidator;
...
public class MangeUsersController {
	...
	/********************************* USER LIST FLOW *************************************************************************/
	@RequestMapping(value = "/showManageUsersList.htm", method = RequestMethod.GET)
	...
	/********************************* CREATE USER FLOW *************************************************************************/
	@RequestMapping(value = "/createManageUser.htm")
	...
	/********************************* DELETE USER FLOW *************************************************************************/
	@RequestMapping(value = "/deleteUserPage.htm")
	...
	/********************************* UPDATE USER FLOW *************************************************************************/
	@RequestMapping(value = "/updateUserPage.htm")
