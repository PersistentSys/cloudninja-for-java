...
import com.persistent.cloudninja.service.TenantTaskListService;
import com.persistent.cloudninja.transferObjects.CreateManageListDTO;
import com.persistent.cloudninja.transferObjects.EditManageListDTO;
import com.persistent.cloudninja.transferObjects.TaskListDTO;
import com.persistent.cloudninja.transferObjects.TrafficSimulationDTO;
import com.persistent.cloudninja.validator.CreateTaskListValidator;
import com.persistent.cloudninja.validator.EditTaskListValidator;
...
public class TenantTaskListController {
	...
	ModelAndView model = new ModelAndView(new RedirectView("/showTenantHomePage.htm", true));
	return model;
    }
    ...
    @RequestMapping(value = "/showTenantHomePage.htm")
	...
	ModelAndView model =  new ModelAndView(new RedirectView("/showTenantHomePageList.htm", true));
	return model;
    }
	...
	//******************************************** Create Task List ****************************************************/
	  ...
	  */
	 @RequestMapping(value="/createNewList.htm",method = RequestMethod.GET)
	 ...
	 * @throws CloudNinjaException
	 */
    @RequestMapping(value = "/createList.htm", method = RequestMethod.POST)
	...
	//******************************************** Delete Task List ****************************************************/
	  ...
	  * @throws CloudNinjaException
	  */
	 @RequestMapping(value="/deleteList.htm")
	 ...
	 */
	 @RequestMapping(value="/listDetails.htm")
	 ...
	 */
	 @RequestMapping(value="/editListPage.htm")
	 ...
	 */
	 @RequestMapping(value = "/editList.htm")
