...
import com.persistent.cloudninja.dao.ProvisioningLogDao;
import com.persistent.cloudninja.dao.TenantDao;
import com.persistent.cloudninja.dao.TenantIdMasterDao;
import com.persistent.cloudninja.dao.TenantProfileDao;
...
public class ProvisioningServiceImpl implements ProvisioningService {
	...
	private void assignRealm(RelyingParty relyingParty, String tenantId) throws Exception {
		...
		realm.setAddress(String.format(strRealm, tenantId, domain));
	...
	private void assignReturnURL(RelyingParty relyingParty, String tenantId) throws Exception {
		RelyingPartyAddress returnURL =
			new RelyingPartyAddress();
		returnURL.setAddress(String.format(this.returnURL, tenantId, domain));
    ...
    public String getDashBoardAccessUrl(String tenantId) {
    	int index = returnURL.lastIndexOf("/");
		String strRealm = returnURL.substring(0, index);
    	String tenantUrl = String.format(strRealm, tenantId, domain);
    	return tenantUrl;
    }
