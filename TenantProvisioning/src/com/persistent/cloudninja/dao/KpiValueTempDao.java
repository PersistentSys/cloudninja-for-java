...
/**
 * DAO for KpiValueTemp.
 *
 */
public interface KpiValueTempDao {
	...
	/**
	 * Adds all the KpiValueTempEntities.
	 * 
	 * @param listKpiValueTempEntities : list of KpiValueTempEntities to add.
	 */
	public void addAll(List<KpiValueTempEntity> listKpiValueTempEntities);
	/**
	 * Executes 'ProcessKpiValues' stored procedure. 
	 */
