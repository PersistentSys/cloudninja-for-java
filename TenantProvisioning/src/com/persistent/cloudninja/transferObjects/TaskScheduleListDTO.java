...
public class TaskScheduleListDTO {
	...
	List<TaskScheduleEntity> taskScheduleList;
    
	/**
	 * Get the schedule task list
	 * @return
	 */
	...
	/**
	 * Set the scheduled task list 
	 * @param taskScheduleList
	 */

	public void setTaskScheduleList(List<TaskScheduleEntity> taskScheduleList) {
