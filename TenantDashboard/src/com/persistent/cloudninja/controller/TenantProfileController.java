...
import com.persistent.cloudninja.service.TenantProfileService;
import com.persistent.cloudninja.transferObjects.LogoFileDTO;
import com.persistent.cloudninja.validator.LogoFileDTOValidator;
...
/******************************************** Tenant Profile ****************************************************/
	...
	@RequestMapping(value="{tenantId}/showTenantProfilePage.htm", method=RequestMethod.GET)
